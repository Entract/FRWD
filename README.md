...
| `fixtures/business-report` | A designed reference document — the demonstration, not just test data |
| `apps/editor` | MVP: open, edit text, move blocks, theme tokens, save, publish |
